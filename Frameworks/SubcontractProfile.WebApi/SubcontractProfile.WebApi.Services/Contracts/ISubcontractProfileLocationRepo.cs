...
namespace SubcontractProfile.WebApi.Services.Contracts
{
    ...
    public partial interface ISubcontractProfileLocationRepo
    {
        ...
        Task<SubcontractProfile.WebApi.Services.Model.SubcontractProfileLocationList> SearchListLocation(SubcontractProfile.WebApi.Services.Model.SearchSubcontractProfileLocationQuery data);
    }
}
