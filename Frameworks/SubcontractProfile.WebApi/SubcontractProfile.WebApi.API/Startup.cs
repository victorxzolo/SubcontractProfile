using SubcontractProfile.WebApi.API.Common.Attributes;
using SubcontractProfile.WebApi.API.Common.Middlewares;
using SubcontractProfile.WebApi.API.Common.Settings;
using SubcontractProfile.WebApi.API.Swagger;
