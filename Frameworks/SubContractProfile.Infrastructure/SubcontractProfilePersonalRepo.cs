...
namespace SubContractProfile.Infrastructure
{
    ...
    public partial interface ISubcontractProfilePersonalRepo
    {
        ...
        Task<IEnumerable<SubcontractProfile.Core.Entities.SubcontractProfilePersonal>> GetAll();
        Task<SubcontractProfile.Core.Entities.SubcontractProfilePersonal> GetByPersonalId(System.Guid personalId);
        Task<bool> Insert(SubcontractProfile.Core.Entities.SubcontractProfilePersonal subcontractProfilePersonal);
        Task<bool> BulkInsert(IEnumerable<SubcontractProfile.Core.Entities.SubcontractProfilePersonal> subcontractProfilePersonalList);
        Task<bool> Update(SubcontractProfile.Core.Entities.SubcontractProfilePersonal subcontractProfilePersonal);
        Task<bool> Delete(System.Guid id);
        Task<IEnumerable<SubcontractProfile.Core.Entities.SubcontractProfilePersonal>> GetByPKList(IEnumerable<SubcontractProfile.Core.Entities.SubcontractProfilePersonal_PK> pkList);
    ...
    public partial class SubcontractProfilePersonalRepo : ISubcontractProfilePersonalRepo
    {
        ...
        public SubcontractProfilePersonalRepo(SubContractProfile.Infrastructure.DbContext dbContext)
        {
        ...
        /// Get all
        /// </summary>
        public async Task<IEnumerable<SubcontractProfile.Core.Entities.SubcontractProfilePersonal>> GetAll()
        {
            var entities = await _dbContext.Connection.QueryAsync<SubcontractProfile.Core.Entities.SubcontractProfilePersonal>
        ...
        /// Get by PK
        /// </summary>
        public async Task<SubcontractProfile.Core.Entities.SubcontractProfilePersonal> GetByPersonalId(System.Guid personalId)
        {
            var p = new DynamicParameters();
            p.Add("@personal_id", personalId);

            var entity = await _dbContext.Connection.QuerySingleOrDefaultAsync<SubcontractProfile.Core.Entities.SubcontractProfilePersonal>
        ...
        /// Insert
        /// </summary>
        public async Task<bool> Insert(SubcontractProfile.Core.Entities.SubcontractProfilePersonal subcontractProfilePersonal)
        {
            var p = new DynamicParameters();
        ...
        /// Update
        /// </summary>
        public async Task<bool> Update(SubcontractProfile.Core.Entities.SubcontractProfilePersonal subcontractProfilePersonal)
        {
            var p = new DynamicParameters();
            p.Add("@personal_id", subcontractProfilePersonal.PersonalId);
            p.Add("@citizen_id", subcontractProfilePersonal.CitizenId);
        ...
        /// Delete
        /// </summary>
        public async Task<bool> Delete(System.Guid personalId)
        {
            var p = new DynamicParameters();
            p.Add("@personal_id", personalId);
        ...
        /// Bulk insert
        /// </summary>
        public async Task<bool> BulkInsert(IEnumerable<SubcontractProfile.Core.Entities.SubcontractProfilePersonal> subcontractProfilePersonalList)
        {
            var p = new DynamicParameters();
        ...
        /// </summary>
        private object CreateSubcontractProfilePersonalDataTable(IEnumerable<SubcontractProfile.Core.Entities.SubcontractProfilePersonal> SubcontractProfilePersonalList)
        {
        ...
        /// Select by PK List
        /// </summary>
        public async Task<IEnumerable<SubcontractProfile.Core.Entities.SubcontractProfilePersonal>> GetByPKList(IEnumerable<SubcontractProfile.Core.Entities.SubcontractProfilePersonal_PK> pkList)
        {
            var p = new DynamicParameters();
        ...
        /// </summary>
        private object CreateSubcontractProfilePersonalPKDataTable(IEnumerable<SubcontractProfile.Core.Entities.SubcontractProfilePersonal_PK> pkList)
        {
            DataTable dt = new DataTable();
            dt.Columns.Add("personal_id", typeof(SqlGuid));
