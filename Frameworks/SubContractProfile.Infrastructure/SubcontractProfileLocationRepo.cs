...
namespace SubContractProfile.Infrastructure
{
    ...
    public partial interface ISubcontractProfileLocationRepo
    {
        ...
        Task<IEnumerable<SubcontractProfile.Core.Entities.SubcontractProfileLocation>> GetAll();
        Task<SubcontractProfile.Core.Entities.SubcontractProfileLocation> GetByLocationId(System.Guid locationId);
        Task<bool> Insert(SubcontractProfile.Core.Entities.SubcontractProfileLocation subcontractProfileLocation);
        Task<bool> BulkInsert(IEnumerable<SubcontractProfile.Core.Entities.SubcontractProfileLocation> subcontractProfileLocationList);
        Task<bool> Update(SubcontractProfile.Core.Entities.SubcontractProfileLocation subcontractProfileLocation);
        Task<bool> Delete(System.Guid id);
        Task<IEnumerable<SubcontractProfile.Core.Entities.SubcontractProfileLocation>> GetByPKList(IEnumerable<SubcontractProfile.Core.Entities.SubcontractProfileLocation_PK> pkList);
    ...
    public partial class SubcontractProfileLocationRepo : ISubcontractProfileLocationRepo
    {
        ...
        public SubcontractProfileLocationRepo(SubContractProfile.Infrastructure.DbContext dbContext)
        {
        ...
        /// Get all
        /// </summary>
        public async Task<IEnumerable<SubcontractProfile.Core.Entities.SubcontractProfileLocation>> GetAll()
        {
            var entities = await _dbContext.Connection.QueryAsync<SubcontractProfile.Core.Entities.SubcontractProfileLocation>
        ...
        /// Get by PK
        /// </summary>
        public async Task<SubcontractProfile.Core.Entities.SubcontractProfileLocation> GetByLocationId(System.Guid locationId)
        {
            var p = new DynamicParameters();
            p.Add("@location_id", locationId);

            var entity = await _dbContext.Connection.QuerySingleOrDefaultAsync<SubcontractProfile.Core.Entities.SubcontractProfileLocation>
        ...
        /// Insert
        /// </summary>
        public async Task<bool> Insert(SubcontractProfile.Core.Entities.SubcontractProfileLocation subcontractProfileLocation)
        {
            var p = new DynamicParameters();
        ...
        /// Update
        /// </summary>
        public async Task<bool> Update(SubcontractProfile.Core.Entities.SubcontractProfileLocation subcontractProfileLocation)
        {
            var p = new DynamicParameters();
            p.Add("@location_id", subcontractProfileLocation.LocationId);
            p.Add("@location_code", subcontractProfileLocation.LocationCode);
        ...
        /// Bulk insert
        /// </summary>
        public async Task<bool> BulkInsert(IEnumerable<SubcontractProfile.Core.Entities.SubcontractProfileLocation> subcontractProfileLocationList)
        {
            var p = new DynamicParameters();
        ...
        /// </summary>
        private object CreateSubcontractProfileLocationDataTable(IEnumerable<SubcontractProfile.Core.Entities.SubcontractProfileLocation> SubcontractProfileLocationList)
        {
        ...
        /// Select by PK List
        /// </summary>
        public async Task<IEnumerable<SubcontractProfile.Core.Entities.SubcontractProfileLocation>> GetByPKList(IEnumerable<SubcontractProfile.Core.Entities.SubcontractProfileLocation_PK> pkList)
        {
            var p = new DynamicParameters();
        ...
        /// </summary>
        private object CreateSubcontractProfileLocationPKDataTable(IEnumerable<SubcontractProfile.Core.Entities.SubcontractProfileLocation_PK> pkList)
        {
            DataTable dt = new DataTable();
            dt.Columns.Add("location_id", typeof(SqlGuid));
