...
namespace SubContractProfile.Infrastructure
{
    ...
    public partial interface ISubcontractProfileTeamRepo
    {
        ...
        Task<IEnumerable<SubcontractProfile.Core.Entities.SubcontractProfileTeam>> GetAll();
        Task<SubcontractProfile.Core.Entities.SubcontractProfileTeam> GetByTeamId(System.Guid teamId);
        Task<bool> Insert(SubcontractProfile.Core.Entities.SubcontractProfileTeam subcontractProfileTeam);
        Task<bool> BulkInsert(IEnumerable<SubcontractProfile.Core.Entities.SubcontractProfileTeam> subcontractProfileTeamList);
        Task<bool> Update(SubcontractProfile.Core.Entities.SubcontractProfileTeam subcontractProfileTeam);
        Task<bool> Delete(System.Guid id);
        Task<IEnumerable<SubcontractProfile.Core.Entities.SubcontractProfileTeam>> GetByPKList(IEnumerable<SubcontractProfile.Core.Entities.SubcontractProfileTeam_PK> pkList);
    ...
    public partial class SubcontractProfileTeamRepo : ISubcontractProfileTeamRepo
    {
        ...
        public SubcontractProfileTeamRepo(SubContractProfile.Infrastructure.DbContext dbContext)
        {
        ...
        /// Get all
        /// </summary>
        public async Task<IEnumerable<SubcontractProfile.Core.Entities.SubcontractProfileTeam>> GetAll()
        {
            var entities = await _dbContext.Connection.QueryAsync<SubcontractProfile.Core.Entities.SubcontractProfileTeam>
        ...
        /// Get by PK
        /// </summary>
        public async Task<SubcontractProfile.Core.Entities.SubcontractProfileTeam> GetByTeamId(System.Guid teamId)
        {
            var p = new DynamicParameters();
            p.Add("@team_id", teamId);

            var entity = await _dbContext.Connection.QuerySingleOrDefaultAsync<SubcontractProfile.Core.Entities.SubcontractProfileTeam>
        ...
        /// Insert
        /// </summary>
        public async Task<bool> Insert(SubcontractProfile.Core.Entities.SubcontractProfileTeam subcontractProfileTeam)
        {
            var p = new DynamicParameters();
        ...
        /// Update
        /// </summary>
        public async Task<bool> Update(SubcontractProfile.Core.Entities.SubcontractProfileTeam subcontractProfileTeam)
        {
            var p = new DynamicParameters();
            p.Add("@team_id", subcontractProfileTeam.TeamId);
            p.Add("@team_code", subcontractProfileTeam.TeamCode);
        ...
        /// Delete
        /// </summary>
        public async Task<bool> Delete(System.Guid teamId)
        {
            var p = new DynamicParameters();
            p.Add("@team_id", teamId);
        ...
        /// Bulk insert
        /// </summary>
        public async Task<bool> BulkInsert(IEnumerable<SubcontractProfile.Core.Entities.SubcontractProfileTeam> subcontractProfileTeamList)
        {
            var p = new DynamicParameters();
        ...
        /// </summary>
        private object CreateSubcontractProfileTeamDataTable(IEnumerable<SubcontractProfile.Core.Entities.SubcontractProfileTeam> SubcontractProfileTeamList)
        {
        ...
        /// Select by PK List
        /// </summary>
        public async Task<IEnumerable<SubcontractProfile.Core.Entities.SubcontractProfileTeam>> GetByPKList(IEnumerable<SubcontractProfile.Core.Entities.SubcontractProfileTeam_PK> pkList)
        {
            var p = new DynamicParameters();
        ...
        /// </summary>
        private object CreateSubcontractProfileTeamPKDataTable(IEnumerable<SubcontractProfile.Core.Entities.SubcontractProfileTeam_PK> pkList)
        {
            DataTable dt = new DataTable();
            dt.Columns.Add("team_id", typeof(SqlGuid));
