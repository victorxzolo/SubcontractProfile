...
namespace SubContractProfile.Infrastructure
{
    ...
    public partial interface ISubcontractProfileEngineerRepo
    {
        ...
        Task<IEnumerable<SubcontractProfile.Core.Entities.SubcontractProfileEngineer>> GetAll();
        Task<SubcontractProfile.Core.Entities.SubcontractProfileEngineer> GetByEngineerId(System.Guid engineerId);
        Task<bool> Insert(SubcontractProfile.Core.Entities.SubcontractProfileEngineer subcontractProfileEngineer);
        Task<bool> BulkInsert(IEnumerable<SubcontractProfile.Core.Entities.SubcontractProfileEngineer> subcontractProfileEngineerList);
        Task<bool> Update(SubcontractProfile.Core.Entities.SubcontractProfileEngineer subcontractProfileEngineer);
        Task<bool> Delete(System.Guid id);
        Task<IEnumerable<SubcontractProfile.Core.Entities.SubcontractProfileEngineer>> GetByPKList(IEnumerable<SubcontractProfile.Core.Entities.SubcontractProfileEngineer_PK> pkList);
    ...
    public partial class SubcontractProfileEngineerRepo : ISubcontractProfileEngineerRepo
    {
        ...
        public SubcontractProfileEngineerRepo(SubContractProfile.Infrastructure.DbContext dbContext)
        {
        ...
        /// Get all
        /// </summary>
        public async Task<IEnumerable<SubcontractProfile.Core.Entities.SubcontractProfileEngineer>> GetAll()
        {
            var entities = await _dbContext.Connection.QueryAsync<SubcontractProfile.Core.Entities.SubcontractProfileEngineer>
        ...
        /// Get by PK
        /// </summary>
        public async Task<SubcontractProfile.Core.Entities.SubcontractProfileEngineer> GetByEngineerId(System.Guid engineerId)
        {
            var p = new DynamicParameters();
            p.Add("@engineer_id", engineerId);

            var entity = await _dbContext.Connection.QuerySingleOrDefaultAsync<SubcontractProfile.Core.Entities.SubcontractProfileEngineer>
        ...
        /// Insert
        /// </summary>
        public async Task<bool> Insert(SubcontractProfile.Core.Entities.SubcontractProfileEngineer subcontractProfileEngineer)
        {
            var p = new DynamicParameters();
        ...
        /// Update
        /// </summary>
        public async Task<bool> Update(SubcontractProfile.Core.Entities.SubcontractProfileEngineer subcontractProfileEngineer)
        {
            var p = new DynamicParameters();
            p.Add("@engineer_id", subcontractProfileEngineer.EngineerId);
            p.Add("@staff_code", subcontractProfileEngineer.StaffCode);
        ...
        /// Delete
        /// </summary>
        public async Task<bool> Delete(System.Guid engineerId)
        {
            var p = new DynamicParameters();
            p.Add("@engineer_id", engineerId);
        ...
        /// Bulk insert
        /// </summary>
        public async Task<bool> BulkInsert(IEnumerable<SubcontractProfile.Core.Entities.SubcontractProfileEngineer> subcontractProfileEngineerList)
        {
            var p = new DynamicParameters();
        ...
        /// </summary>
        private object CreateSubcontractProfileEngineerDataTable(IEnumerable<SubcontractProfile.Core.Entities.SubcontractProfileEngineer> SubcontractProfileEngineerList)
        {
        ...
        /// Select by PK List
        /// </summary>
        public async Task<IEnumerable<SubcontractProfile.Core.Entities.SubcontractProfileEngineer>> GetByPKList(IEnumerable<SubcontractProfile.Core.Entities.SubcontractProfileEngineer_PK> pkList)
        {
            var p = new DynamicParameters();
        ...
        /// </summary>
        private object CreateSubcontractProfileEngineerPKDataTable(IEnumerable<SubcontractProfile.Core.Entities.SubcontractProfileEngineer_PK> pkList)
        {
            DataTable dt = new DataTable();
            dt.Columns.Add("engineer_id", typeof(SqlGuid));
