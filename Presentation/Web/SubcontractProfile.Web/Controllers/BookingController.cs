...
namespace SubcontractProfile.Web.Controllers
{
    public class BookingController : Controller
    {
        ...
        public BookingController(IConfiguration configuration, IHttpContextAccessor httpContextAccessor, IStringLocalizer<BookingController> localizer)
        {
        ...
        public IActionResult Index()
        {
            ...
            ViewData["Controller"] = _localizer["Booking"];
        ...
        public IActionResult request()
        {
            ...
            ViewData["Controller"] = _localizer["Booking"];
            ViewData["View"] = _localizer["Booking"];
