...
{
    public class ReportTeamController : Controller
    {
        ...
        private string Lang = "";
        private readonly IStringLocalizer<ReportTeamController> _localizer;
        public ReportTeamController(IConfiguration configuration, IHttpContextAccessor httpContextAccessor, IStringLocalizer<ReportTeamController> localizer)
        {
        ...
        public IActionResult Index()
        {
            ...
            ViewData["View"] = _localizer["ReportTeamController"];
        ...
        public IActionResult SearchTeam(string teamcode ,string vendorcode, string locationcode, string createFrom, string createTo)
        {
            ...
            string uriString = string.Format("{0}/{1}/{2}/{3}/{4}/{5}", strpathAPI + "team/selectTeamAll"
