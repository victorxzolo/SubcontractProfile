...
namespace SubcontractProfile.Web.Controllers
{
    public class ReportLocationController : Controller
    {
        ...
        private string Lang = "";
        private readonly IStringLocalizer<ReportLocationController> _localizer;
        public ReportLocationController(IConfiguration configuration, IHttpContextAccessor httpContextAccessor, IStringLocalizer<ReportLocationController> localizer)
        {
        ...
        public IActionResult Index()
        {
            ...
            ViewData["View"] = _localizer["ReportLocationController"];
        ...
        public IActionResult SearchLocation( string vendorcode , string locationcode ,string createFrom ,string createTo)
        {
            ...
            string uriString = string.Format("{0}/{1}/{2}/{3}/{4}", strpathAPI + "Location/selectLocationAll"
