...
namespace SubcontractProfile.Web.Controllers
{
    public class ReportCompanyController : Controller
    {
        ...
        private string Lang = "";
        private readonly IStringLocalizer<ReportCompanyController> _localizer;
        public ReportCompanyController(IConfiguration configuration, IHttpContextAccessor httpContextAccessor, IStringLocalizer<ReportCompanyController> localizer)
        {
        ...
        public IActionResult Index()
        {
            ...
            ViewData["View"] = _localizer["ReportCompanyController"];
        ...
        public IActionResult SearchCompany(string vendorcode, string companycode, string companyname, string createFrom, string createTo)
        {
